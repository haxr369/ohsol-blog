...
draft: true
summary: DNS + AWS Route53 프로젝트 적용
---
...
여기어때 클론코딩을 수행하면서 epicktrees.net이라는 도메인을 사용했다.
아래 그림을 보면 epicktrees.net과 api.epicktrees.net 두 도메인을 A 레코드를 사용한 것을 볼 수 있다.
또한 각각 awsdns host master와 로그벨런서로 트래픽 라우팅이 되어 브라우저가 얻고자하는 IP 주소를 각 리소스로부터 얻을 수 있다.

<br />
<img src="/source/aws_route53.png" />
<br />
